...
class Student:
    def __init__(self,root):
        ...
        # #second image
        # img1=Image.open(r"online_images\hl.jpeg")
        # img1=img1.resize((500,70),Image.ANTIALIAS)
        # self.photoimg1=ImageTk.PhotoImage(img1)

        # f_lbl=Label(self.root,image=self.photoimg1)
        # f_lbl.place(x=500,y=0,width=500,height=70)

        # #third image
        # img2=Image.open(r"online_images\hl.jpeg")
        # img2=img2.resize((500,70),Image.ANTIALIAS)
        # self.photoimg2=ImageTk.PhotoImage(img2)

        # f_lbl=Label(self.root,image=self.photoimg2)
        # f_lbl.place(x=1000,y=0,width=500,height=70)        
        ...
        f_lbl.place(x=0,y=0,width=600,height=50) 
         #current course       
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course Information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=10,y=54,width=640,height=120)
        #department
        ...
        dep_combo["values"]=("Select Dept.","computer science","ECE")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course.","computer science","ECE")
        ...
        class_student_frame.place(x=10,y=180,width=640,height=360)
        ...
        #student name
        student_id_label=Label(class_student_frame,text="Student Name:",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=0,column=2,padx=2,pady=10,sticky=W)
        ...
        #class division
        student_id_label=Label(class_student_frame,text="Class Division:",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=1,column=0,padx=2,pady=10,sticky=W)
        ...
        studentID_entry=ttk.Entry(class_student_frame,textvariable=self.var_div,width=20,font=("times new roman",12,"bold"))
        studentID_entry.grid(row=1,column=1,padx=10,sticky=W)
        #roll no
        student_id_label=Label(class_student_frame,text="Roll No.:",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=1,column=2,padx=2,pady=10,sticky=W)
        ...
        #gender
        student_id_label=Label(class_student_frame,text="Gender:",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=2,column=0,padx=2,pady=10,sticky=W)
        ...
        studentID_entry=ttk.Entry(class_student_frame,textvariable=self.var_gender,width=20,font=("times new roman",12,"bold"))
        studentID_entry.grid(row=2,column=1,padx=10,sticky=W)
        #date of birth
        student_id_label=Label(class_student_frame,text="Date Of Birth:",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=2,column=2,padx=2,pady=10,sticky=W)
        ...
        #email
        student_id_label=Label(class_student_frame,text="Email ID:",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=3,column=0,padx=2,pady=10,sticky=W)
        ...
        #phone number
        student_id_label=Label(class_student_frame,text="Phone No. :",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=3,column=2,padx=2,pady=10,sticky=W)
        ...
        #address
        student_id_label=Label(class_student_frame,text="Address:",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=4,column=0,padx=2,pady=10,sticky=W)
        ...
        #teacher name
        student_id_label=Label(class_student_frame,text="Teacher Name:",font=("times new roman",12,"bold"),bg="white")
        student_id_label.grid(row=4,column=2,padx=2,pady=10,sticky=W)

        studentID_entry=ttk.Entry(class_student_frame,textvariable=self.var_teacher,width=20,font=("times new roman",12,"bold"))
        studentID_entry.grid(row=4,column=3,padx=10,sticky=W)
        ...
        btn_frame1.place(x=10,y=280,width=600,height=35)
        ...
        img_right=Image.open(r"C:\Users\ManiKanta.K\Desktop\FACE RECOGNITION SYSTEM\online_images\chip.jpg")
        img_right=img.resize((432,70),Image.ANTIALIAS)
        self.photoimg_right=ImageTk.PhotoImage(img_right)

        f_lbl=Label(Right_frame,image=self.photoimg_left)
        f_lbl.place(x=0,y=0,width=432,height=50)

        #searching system
        Search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Search System",font=("times new roman",12,"bold"))
        Search_frame.place(x=10,y=60,width=530,height=70)
        ...
        table_frame.place(x=10,y=135,width=530,height=400)
...
#===========function declaration===================
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Dept." or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                Upadate=messagebox.askyesno("Update","Do you want to update thus student details",parent=self.root)
                if Upadate>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="",database="face_recognizer")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dev=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,DOB=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
                                                                                self.var_dep.get(),
                                                                                self.var_course.get(),
                                                                                self.var_year.get(),
                                                                                self.var_semester.get(),                              
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                delete=messagebox.askyesno("Student Delete Page","D o you want to delete this student",parent=self.root)
                if delete>0:
                        conn=mysql.connector.connect(host="localhost",username="root",password="",database="face_recognizer")
                        my_cursor=conn.cursor()
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Dept." or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                messagebox.showinfo("Result","Generating data sts completed !!")
            except Exception as es:
                messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)
